...
class VC
{
	...
	setOptions( newConfig ) {
		this.clearInterval = newConfig.cl;
		this.lineWidth = newConfig.lw;
		this.blend = newConfig.bl;
		this.brightness = newConfig.br;
		this.saturation = newConfig.sa;

		//those settings are taken from json file
		this.hFreq = newConfig.hf;
		this.vFreq = newConfig.vf;
		this.overScan = newConfig.os;
		this.hOffset = newConfig.ho;
		this.pulseLength = newConfig.pl;
